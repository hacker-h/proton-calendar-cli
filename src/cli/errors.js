...
const VALIDATION_ERROR_CODES = new Set([
  "CONFIG_ERROR",
  "EMPTY_PATCH",
  "ICS_IMPORT_BATCH_TOO_LARGE",
  "ICS_IMPORT_EVENT_LIMIT",
  "ICS_IMPORT_TOO_LARGE",
  "ICS_INVALID_TIMEZONE",
  "ICS_CANCELLED_EVENT",
  "ICS_EXPORT_EVENT_LIMIT",
  "ICS_INVALID_DATE",
  "ICS_INVALID_EVENT",
  "ICS_UNSUPPORTED_COMPONENT",
  "ICS_UNSUPPORTED_PROPERTY",
  "INVALID_ARGS",
  "INVALID_REMINDERS",
  "INVALID_TIMEZONE",
